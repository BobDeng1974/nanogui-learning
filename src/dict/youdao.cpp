            ...
            while (node) {
                ...
                if (memcmp(node->Value(), "return-phrase", 13) == 0) {
                    ...
                    while (sub) {
                        ...
                        values->insert("translation",
                                       std::string(sub->FirstChildElement("content")->GetText()));
                    ...
                    while (sub) {
                        ...
                        while (trans) {
                            ...
                            val = val + std::string(trans->FirstChildElement("value")->GetText()) +
                                  std::string("; ");
                    ...
                    while (sub) {
                        ...
                        std::string val = std::string(
                                              sub->FirstChildElement("sentence-translation")->GetText());
